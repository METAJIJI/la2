...
class RegisterRouter(object):
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        if obj1._meta.app_label == 'register' and obj2._meta.app_label == 'register':
            return True
        # Allow if neither is chinook app
        elif 'register' not in [obj1._meta.app_label, obj2._meta.app_label]:
            return True
        return False
    
    def allow_syncdb(self, db, model):
        if db == 'server' or model._meta.app_label == "register":
